...
function SidebarLink({ src, label, href }) {
  return (
    <li>
      <Link href={href}  class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
